...
void handleRoot() {
  ...
  String message = homePagePart1 + temperature + homePagePart2 + humidity + homePagePart3a + beat + homePagePart3 + O2 + homePagePart4 + getAlert() + homePagePart5 + fallDetection() + homePagePart5 + s + homePagePart6;
...
void checkAlerts() {
  ...
  if (fallDetection() == "FALL DETECTED!" || digitalRead(BUTTON_PIN) == HIGH) {
    ...
    String details = "\nHealth readings for patient A: \n Temperature :" + String(temperature) + "\n Humidity: " + String(humidity) + "%\n HeartBeat : " + String(beat) + "\n Oxygen levels:" + String(O2) + "\n";

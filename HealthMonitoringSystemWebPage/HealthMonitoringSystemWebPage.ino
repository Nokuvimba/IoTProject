...
#include <Adafruit_MPU6050.h> //fall detection
#include <Adafruit_Sensor.h>

#include "MAX30100_PulseOximeter.h" //heartRate
#define REPORTING_PERIOD_MS     1000
PulseOximeter pox;
uint32_t tsLastReport = 0;

#include <Arduino.h>
#include "DHT_Async.h" //non-blocking DHT11
...
byte degree[] = { //degree celsius character
  B11000,
  B11000,
  B00000,
  B00111,
...
dht_sensor.measure(&temperature, &humidity);
  ...
  String message =  homePagePart1 + String(temperature, 1) + homePagePart2 + String(humidity, 1)+homePagePart3 + String(pox.getHeartRate()) + homePagePart4 + getAlert() + homePagePart5 + fallDetection() + homePagePart6;
